        ...
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="text-sm px-5 py-2 bg-black text-white rounded-full shadow-[0_4px_18px_-3px_rgba(0,0,0,0.4)] hover:shadow-[0_8px_28px_-4px_rgba(0,0,0,0.55)] hover:bg-gray-900 hover:-translate-y-0.5 transition-all duration-300 shrink-0"
            >
              Предложить сценарий
            </button>
          </div>
