...
import { getAllArticles, countArticlesInSubsystem } from '@/lib/content'
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-14 md:py-20">
      ...
      <section className="mb-20">
        <Reveal>
          <h2 className="text-xs uppercase tracking-[0.12em] text-gray-400 font-medium mb-6">По бизнес-процессам</h2>
        </Reveal>
        <ul className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {TREE.map((subsystem, i) => {
              ...
              <li key={subsystem.slug}>
                <Reveal delay={i * 60} className="h-full">
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-600 leading-relaxed line-clamp-3">{subsystem.description}</p>
      ...
      <section className="mb-20">
        <Reveal>
          <h2 className="text-xs uppercase tracking-[0.12em] text-gray-400 font-medium mb-6">По отраслям</h2>
          <IndustryTagCloud />
        </Reveal>
      </section>
      ...
      {recent.length > 0 && (
        <section>
          <Reveal>
            <h2 className="text-xs uppercase tracking-[0.12em] text-gray-400 font-medium mb-6">Свежие статьи</h2>
          </Reveal>
